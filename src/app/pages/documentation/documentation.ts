...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">PlayerTech WebApp is an Angular and PrimeNG frontend starter that will evolve into a multi-tenant academy management application. Current versions are Angular v21 with PrimeNG v21. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
<code>npm install -g &#64;angular/cli</code></pre>
            ...
            <pre class="app-code">
<code>git clone --recurse-submodules https://github.com/primefaces/sakai-ng
npm install
ng serve</code></pre>
